...
export const TEAM_PERMISSIONS = [
  { key: 'post_job', label: 'Post Job', routes: ['/company/post-job'] },
  { key: 'my_jobs', label: 'My Jobs', routes: ['/company/jobs'] },
  { key: 'candidate_search', label: 'Candidate Search', routes: ['/company/candidate-search'] },
  ...
  { key: 'bulk_applicant_management', label: 'Bulk Applicant Management', routes: ['/company/bulk-applications'] },
