...
const { updateProfile, uploadResume, toggleSaveJob, getSavedJobs, getPublicProfile, toggleBlockEntity, trackProfileView, getProfileViewers } = require('../controllers/userController');
